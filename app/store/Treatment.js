    ...
    config:{
        ...
        data : [{
                ...
                html: '<div style="margin:10px" class="leaf_panel"><br>'+
                    ...
                    '<p><img class="imagem" style="float: left;  width: 100%;padding: 10px;" src="imgs/technical-support.jpg" alt=""></p>'+
                    ...
                    '<p><img class="imagem" style="float: left;  width: 100%;padding: 10px;" src="imgs/prefsuite.jpg" alt=""></p>'+
