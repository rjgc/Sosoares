            ...
            root: {
               ...
               items: [{
                    ...
                    html: '<p style="">Depois do desenvolvimento da solução com perfil de alumínio extrudido e da execução da ferramenta que lhe dará origem, vemos proceder à extrusão desse perfil.</p>'+
                        '<p style="">O processo de extrusão inicia-se com o pré-aquecimento (cerca de 450ºC) dos biletes de alumínio que são posteriormente inseridos dentro da prensa de extrusão.</p>'+
