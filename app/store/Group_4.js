        ...
        //model: 'App.model.Grocery',
            ...
            root: {
                ...
                },
                {
                    id: 2,
                    text: 'Quienes Somos',
                    html: '<h4><strong>Un asociado continúo...</strong></h4><p>El Grupo Sosoares está comprometido y valora la colaboración con sus clientes y transformistas en el desarrollo del producto en su procesamiento y servicios posventa con el objetivo último de garantizar la satisfacción del cliente. Con este objetivo, el grupo cuenta con:</p><ul class="lista"><li><strong>Oficina de &nbsp;Desarrollo</strong> y análisis con profesionales calificados en ingeniería &nbsp;y arquitectura para la creación de nuevos sistemas y el aumento de los ya existentes.</li><li><strong>Cerrajería</strong> para taller de capacitación y trabajos de montaje.</li><li><strong>Oficina de presupuesto</strong> con una equipa de estimadores para apoyar el presupuesto a los clientes.</li><li>Soporte <strong>Helpdesk</strong> para la instalación de software de presupuesto, creación y actualización de la base de datos, así como la formación de usuarios.</li><li><strong>Un equipo comercial</strong> para proporcionar la divulgación de sistemas de vidrio y aluminio para la arquitectura, delegados técnicos comerciales, cuya función es apoyar a sus clientes. Así que el tiempo puede ser minimizado en la búsqueda de información y la obtención de las mejores soluciones técnicas.</li></ul>',
                    foto: 'imgs/sosoares.jpg',
                    icon: 'icon-apoio',
                    leaf: true
                },
                ...
                },
                {
                    ...
                    html: '<p>El desarrollo de los marcos de aluminio integrados y vidrio ha sido una prioridad de Grupo Sosoares.</p><p>Estos sistemas integrados permiten resolver todos los condicionantes técnicos y estéticos exigidos por la evolución de la arquitectura moderna.</p><p>El seguimiento del proyecto desde la etapa de la arquitectura para la ejecución de la obra, permite la correcta implementación de la solución deseada y constante innovación de productos.</p>',
                    foto: 'imgs/sosoares.jpg',
                    icon: 'icon-apoio',
                    leaf: true
                },
