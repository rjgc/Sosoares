        ...
        //model: 'App.model.Grocery',
            ...
            root: {
                ...
                },
                {
                    ...
                    html: '<p><strong>Un partenaire continue ...</strong></p><p>Groupe Sosoares est engagé et valorise le partenariat avec ses clients et les transformateurs et dans le développement de produit, dans sa fabrication et le service après-vente dans le but ultime d\'assurer la satisfaction du client. Avec cet objectif, le groupe a:</p><p>• <strong>Bureau de Développent</strong> et analyse avec des professionnels qualifiés dans l\'ingénierie et de l\'architecture pour la création de nouveaux systèmes et complément de celles déjà existantes.</p><p>• <strong>Menuiserie pour l\'atelier</strong> de formation et d’installation dans le chantier.</p><p>• <strong>Département du budget</strong> avec un equipe de estimateurs pour soutenir la budgétisation pour les clients.</p><p>• <strong>Appui Helpdesk</strong> pour l\'installation de logiciels de budgétisation, la création et la mise à jour de la base de données ainsi que la formation des utilisateurs.</p><p>• Une<strong> équipe commerciale</strong> pour promouvoir l\'aluminium et des systèmes de verre pour l\'architecture avec délégués commerciaux, dont la fonction est d\'accompagner ses clients. Donc, le temps peut être réduit dans la recherche d\'informations et obtenir les meilleures solutions techniques.</p>',
                    foto: 'imgs/sosoares.jpg',
                    icon: 'icon-apoio',
                    leaf: true
                },
                {
                    ...
                    html: '<p>Développer, produire et commercialiser des systèmes en aluminium et verre pour l’architecture qui constituent des solutions d’ensembles différents alliant fonctionnalité, confort, esthétique et efficacité énergétique de façon à assurer la totale satisfaction des utilisateurs et contribuer à la protection de la planète.</p><p>Exporter, se substituer aux importations, créer des emplois, produire de la richesse, élever le niveau de vie des collaborateurs et optimiser la compétitivité de vos clients, c’est la mission du Groupe.</p>',
                    foto: 'imgs/sosoares.jpg',
                    icon: 'icon-apoio',
                    leaf: true
                },
