      ...
      /*  defaultRootProperty: 'items',
        ...
        //model: 'App.model.Grocery',
            ...
            root: {
                ...
                items: [{
                    text: 'Grupo Sosoares',
                    html: '<h4><strong>História</strong></h4><p style="text-align: justify;">Iniciou-se em 26 de Dezembro de 1979 com a continuação da sociedade comercial por cotas “Sosoares Maquinas e Ferragens Lda”, cuja atividade começou por ser o comércio de maquinas e ferragens para a industria de caixilharias de alumínio.</p><p style="text-align: justify;">Consequência de uma estratégia e do posicionamento da empresa no mercado orientada para a inovação, qualidade de produto e serviço ao cliente, esta foi traçando sustentadamente o seu percurso de crescimento, transformando-se em Grupo por via de aquisições e participações com o objetivo de verticalizar o seu negócio.</p><h4 style="text-align: justify;"><strong>O Presente</strong></h4><p style="text-align: justify;">O grupo é hoje constituído por 5 P.M.E’s, “Alfa Sul S.A.” “Alulider, Lda”, “Metalfer S.A.”, “Perfis Oeiras S.A.” e “Sosoares S.A.” – que se complementam entre si no projeto, desenvolvimento, produção, tratamento de superfícies e comercialização de perfis de alumínio e vidro para arquitetura, distribuindo com a marca própria “Sistemas Euro 2000”.</p><p style="text-align: justify;">Conta com mais de 250 colaboradores empenhados e motivados, dos quais 28 técnicos comerciais direcionados ao apoio direto aos clientes. Obteve em 2013 um volume de negócios de aproximadamente 32 milhões de euros.</p><p style="text-align: justify;">O grupo, atento à atual conjuntura e à evolução da arquitetura de edifícios, conclui recentemente um investimento de cerca de 15 milhões de euros numa unidade de transformação de vidro, integrando as mais recentes tecnologias e uma gama completa de equipamentos de ultima geração na transformação de vidro para arquitetura, tendo como objetivo, por um lado complementar a sua atividade integrando no produto final, os dois materiais de sua produção o alumínio e o vidro, acrescentando-lhes valor e diferenciação, por outro lado dar resposta às solicitações dos profissionais do sector que lideram a corrente arquitetónica visado para a transparência em que o material dominante é o vidro e os fatores de relação são:</p><p>I – Estética minimalista (máxima transparência, mínima vista estrutural)</p><p>II – Conforto e ambiente</p><ul class="lista"><li>Iluminação natural</li><li>Transmissão luminosa</li><li>Controlo solar (efeito estufa versus ganho solar)</li><li>Eficiência térmica (redução de percas energéticas)</li></ul><p>III – Segurança</p><ul class="lista"><li>Proteção acidentes pessoais (laminado, temperado, termoendurecido)</li><li>Anti-intrusão</li><li>Anti-projectil</li></ul><p>IV – Integração Decorativa</p><ul class="lista"><li>Opacificação</li><li>Serigrafia</li><li>Pintura Digital Vitrificada</li><li>Pintura Digital no P.V.B (laminado)</li></ul>',
