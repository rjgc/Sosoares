            ...
            root: {
                ...
                },
               {
                    text: 'Pintura Digital Vitrificada',
                     html: 'A possibilidade de criar uma fachada em vidro e personalizá-la com uma imagem, uma fotografia ou um desenho, é agora possível, por intermédio de um processo de pintura digital. O processo consiste na deposição da tinta de base cerâmica no vidro, através de uma plotter.'+
                           ...
                           'Embora possa ser aplicado em interiores a sua utilização está mais direcionada para o exterior pois permite, juntamente com o vidro apropriado, um melhor controlo solar bem como de graduação da transmissão luminosa sem alteração das cores impressas.'+
                           'Esta nova tecnologia permite aos projectistas combinar e graduar a intensidade luminosa e o controlo solar em vidros termicamente eficientes num amplo leque de soluções decorativas onde o limite é o imaginário.',
                ...
                },
                {
                    ...
                    html: '<p style="text-align: justify;">A opacificação é o método mais rápido e simples quando se pretende pintar um vidro com uma única cor.</p>'+
                        ...
                        '<p style="text-align: justify;">A fusão da tinta no vidro garante a inalterabilidade das cores pelo que também se recomenda a sua aplicação no exterior.</p>'+
                        '<p style="text-align: justify;">Os efeitos estéticos conseguidos pela reflexão da luz, realçam a beleza da fachada</p>',
